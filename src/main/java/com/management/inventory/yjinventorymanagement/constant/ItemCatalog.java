...
public enum ItemCatalog {
    ...
    BACON_CLUBHOUSE_BURGER("Thick-cut Apple-wood smoked bacon, white Cheddar, crisp leaf lettuce and fresh tomato, all lovingly layered on a quarter pound of 100% pure beef, then topped with Big Mac special sauce", 1099L, new Bun(), new Patty(), new Cheese(), new Tomato(), new Lettuce(), new Tomato(), new Bun()),
